...
namespace SailwindCoop.Sync
{
    ...
    /// 4 раза в секунду. (Ровно так это сделано в similar co-op implementations; предыдущая здешняя
    /// попытка глушила апдейтер и писала выходы — она давала пульсацию и в игре была хуже.)
    /// </summary>
